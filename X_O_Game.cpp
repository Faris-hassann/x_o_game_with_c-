...
void swap_player_and_style()
{
    ...
    if (current_marker == 'X')
    {
        ...
        // change the color to blue for the 'O' to play
        system("color 9");
    }    
    else 
    {
        ...
        // change the color to green for the 'X' to play
        system("color a");
    }

    // change the player
    if (current_player == 1)
        current_player = 2; // change from the first player to the second player
    else
        current_player = 1; // changer from the second player to the first player
...
{ 
    ...
    int player_won; // for player who won
